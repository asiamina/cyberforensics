...
$(document).ready(function () {$('body').append('<div id="chat_div"></div><div id="log"></div><!-- Chat Head --><a id="chat-head" href="#"><i>1</i></a>');
   ...
   reg = typeof reg !== 'undefined' ? reg : /\, |\. /g; // list of words to omit, if you use weights do not set score for that word
     csv = typeof csv !== 'undefined' ? csv : "faqen.csv";   // file with questions and answers
...
(function($) {
    $.widget("ui.chatbox", {
        ...
        _create: function() {
          ...
          if (train){   uiChatboxRest = (self.uiChatboxRest = $('<div><ul>	<li>		<a href="#">Related Answers</a>	<ul id="respuestarel">		</ul>		</li>	<li>		<a href="#">Trainer</a>		<ul class="closedt" id="entrena">	<li>How would you classify the answer?	<br>	<center><button type="button" id="correcto">Correct</button>       <button type="button" id="falso">False</button></center><br><center> <button type="button" id="guardar">Save training</button></center></li><li id="listo"></li> 	</ul></li>	</ul></div>'))
                .addClass('ui-widget-content ' +
                          'ui-chatbox-rest ' 
                         )
                .appendTo(uiChatboxContent);}
        
      else{  uiChatboxRest = (self.uiChatboxRest = $('<div><ul>	<li>		<a href="#">Related Answers</a>	<ul id="respuestarel">		</ul>		</li>		<li>Answer not found? please drop us a message at "CONTACT US" section of this page.</li></ul></div>'))
                .addClass('ui-widget-content ' +
                          'ui-chatbox-rest ' 
                         )
                .appendTo(uiChatboxContent);}
...
var anterior=0, temp=0, inda=0;
    $(document).ready(function(){
       ...
       function start(){
              ...
              $("#chat_div").chatbox("option", "boxManager").addMsg(nameagent, "Good day, how are you?\nCan I help you with something?");
...
data.forEach(function(d) {
 ...
 $("#listo").html('<li><font color="black">'+"Thank you, Information Sent"+"</li>");
 //console.log(msg);
});
...
$( "#falso" ).unbind().click(function() {
  ...
  $("#listo").html('Correct: <input type="text" name="fname" size="35" id="rcorr"><br><br><center><input type="submit" id="enviado" value="Send"></center>');
$( "#enviado" ).unbind().click(function() {
    var bla = $('#rcorr').val();
    //console.log(bla);
   // console.log(msg);
   var strweights="";
   for (i = 0; i < largo; i++) {
       ...
       data.push({Question:msg,Answer:bla,Weights:strweights});
 $("#listo").html('<li><font color="black">'+"Thank you, Information Sent"+"</li>");
});
